...
use super::bootstrap::ensure_self_venv;
use super::consts::VENV_BIN;
use super::platform::get_app_dir;
use super::sources::PythonVersion;
use super::sync::create_virtualenv;
use super::utils::{get_venv_python_bin, CommandOutput};
...
fn get_pip_tools_bin(py_ver: &PythonVersion, output: CommandOutput) -> Result<PathBuf, Error> {
    ...
    if output != CommandOutput::Quiet {
        info!("Creating virtualenv for pip-tools");
    }
