...
pub fn update_workspace_lockfile(
    ...
    if output != CommandOutput::Quiet {
        info!("Generating {} lockfile: {}", lock_mode, lockfile.display());
    }
