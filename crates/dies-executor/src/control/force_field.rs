...
impl Obstacle {
    ...
    pub fn new(position: Vector2, radius: f64, velocity: Vector2) -> Self {
        Self {
            position,
            radius,
            velocity,
    ...
    pub fn new_without_vel(position: Vector2, radius: f64) -> Self {
        Self {
            position,
            radius,
