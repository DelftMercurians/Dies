...
/**
 * Context Menu component following the Dies mission control aesthetic.
 *
 * Design specs:
 * - Sharp corners
 * - bg-elevated background, border-std borders
 * - Compact item height: 24px
 * - Hover: bg-overlay
 */
...
>(({ className, ...props }, ref) => (
  <ContextMenuPrimitive.SubContent
    ...
    className={cn(
      ...
      "border border-border-std bg-bg-elevated p-1 text-text-std",
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    <span className="absolute left-1.5 flex h-3 w-3 items-center justify-center">
      <ContextMenuPrimitive.ItemIndicator>
        <Circle className="h-2 w-2 fill-accent-cyan text-accent-cyan" />
      </ContextMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </ContextMenuPrimitive.RadioItem>
